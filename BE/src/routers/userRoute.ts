...
import { getAllUsers, createUser, updateUser, deleteUser, changePicture, login, getUserById } from "../controllers/userController"
...
app.post(`/register`, [ uploadFile.single("picture")], createUser)
app.put(`/:id`, verifyToken, [uploadFile.single("picture")], updateUser)
app.put(`/profile/:id`, [ uploadFile.single("picture")], changePicture)
app.delete(`/:id`, [verifyToken, verifyRole(["USER"])], deleteUser)
